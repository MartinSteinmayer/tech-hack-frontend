export const mockSuppliers = [
    ...
    },
    {
        ...
        description: 'Global Packaging Solutions provides innovative and sustainable packaging solutions for consumer goods, electronics, and food industries with a focus on eco-friendly materials and designs.',
        category: 'Packaging',
        ...
        riskFactors: [
            { category: 'Geopolitical', level: 'low', description: 'Stable political environment with strong regulatory framework' },
            { category: 'Supply Chain', level: 'medium', description: 'Some dependency on raw material imports from overseas' },
            { category: 'Financial', level: 'low', description: 'Well-established company with diverse customer base' },
        ],
        products: [
    ...
    },
    {
        ...
        description: 'RawMat Suppliers Inc specializes in providing high-quality raw materials for manufacturing processes across multiple industries, with expertise in industrial polymers, adhesives, and specialized metals.',
        ...
        riskFactors: [
            { category: 'Geopolitical', level: 'low', description: 'Stable business environment with favorable regulations' },
            { category: 'Supply Chain', level: 'medium', description: 'Some vulnerability to raw material price fluctuations' },
            { category: 'Financial', level: 'medium', description: 'Recent expansion has increased debt load' },
        ],
        products: [
    ...
    },
    {
        ...
        description: 'FastTrack Logistics offers comprehensive logistics solutions including express shipping, warehousing, and distribution services with a focus on speed and reliability for time-sensitive supply chains.',
        category: 'Logistics',
        ...
        riskFactors: [
            { category: 'Geopolitical', level: 'low', description: 'Strong presence in stable markets' },
            { category: 'Supply Chain', level: 'high', description: 'Vulnerable to fuel price fluctuations and labor shortages' },
    ...
    },
    {
        ...
        description: 'Quality Service Providers delivers professional consulting services focused on quality management, process improvement, and regulatory compliance for manufacturing and service industries.',
        category: 'Services',
        ...
        riskFactors: [
            { category: 'Geopolitical', level: 'low', description: 'Operates in stable business environments' },
            { category: 'Supply Chain', level: 'low', description: 'Service-based business with minimal supply chain dependencies' },
            { category: 'Financial', level: 'medium', description: 'Small company with limited financial buffers' },
        ],
        products: [
    ...
    },
    {
        ...
        description: 'ChemSolutions Ltd manufactures and distributes a wide range of industrial chemicals, solvents, and specialized chemical products for manufacturing, cleaning, and industrial processes.',
        category: 'Chemicals',
        ...
        riskFactors: [
            { category: 'Geopolitical', level: 'low', description: 'Operates in stable European markets with good regulatory oversight' },
            { category: 'Supply Chain', level: 'medium', description: 'Some raw materials sourced from regions with potential instability' },
            { category: 'Financial', level: 'low', description: 'Strong financial position with healthy profit margins' },
        ],
        products: [
